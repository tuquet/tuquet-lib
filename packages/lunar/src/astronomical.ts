...
/**
 * Discard the fractional part of a number (floor).
 */
...
/**
 * Compute the Julian Day Number for a given Gregorian/Julian date.
 */
...
/**
 * Convert a Julian Day Number back to Gregorian { day, month, year }.
 */
...
/**
 * Compute the time of the k-th new moon after 1900-01-01 13:52 UTC.
 */
...
/**
 * Compute the true longitude of the sun at a given Julian day number.
 */
 ...
 * Returns an integer 0..11 representing major solar terms (Trung khí).
 */
